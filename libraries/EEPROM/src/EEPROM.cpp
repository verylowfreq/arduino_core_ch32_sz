...
bool EEPROMClass::commit()
{
  ...
  // Serial.printf("Erase page 0x%08x\r\n", EEPROM_AREA_ADDRESS);
  // FLASH_ErasePage_Fast(EEPROM_AREA_ADDRESS);
  // Serial.printf("Erase page 0x%08x\r\n", EEPROM_AREA_ADDRESS + FLASH_PAGE_SIZE);
  // FLASH_ErasePage_Fast(EEPROM_AREA_ADDRESS + FLASH_PAGE_SIZE);
  // FLASH_ProgramPage_Fast(EEPROM_AREA_ADDRESS, (uint32_t*)&_data[0]);
  // FLASH_ProgramPage_Fast(EEPROM_AREA_ADDRESS + FLASH_PAGE_SIZE, (uint32_t*)(&_data[FLASH_PAGE_SIZE]));
